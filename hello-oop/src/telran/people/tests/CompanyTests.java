...
import telran.people.ICompany;

class CompanyTests {
	private static final long ID1 = 1;
	private static final int BIRTH_YEAR1 = 1980;
	private static final String EMAIL1 = "employee1@gmail.com";
	...
	private static final int HOURS2 = 0;
	...
	void testAddEmployee() {
		long id = 11111111;
		assertTrue(company.addEmployee(new Employee(id, 0, null, 0)));
		assertFalse(company.addEmployee(new Employee(id, 0, null, 0)));
	}
	...
	@Test
	void testComputeSalaryBuget() {
		assertEquals(11000, + 1100 + 2000, company.computeSalaryBuget());
	}
